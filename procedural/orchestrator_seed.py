...
# Scale anchors in order (from scales system)
POLARITY_ANCHORS = ['hate', 'dislike', 'neutral', 'like', 'love']
INTENSITY_ANCHORS = ['mild', 'moderate', 'strong', 'extreme']
TEMPERATURE_ANCHORS = ['cold', 'cool', 'warm', 'hot']
DIRECTION_ANCHORS = ['backward', 'stationary', 'forward']
STABILITY_ANCHORS = ['unstable', 'neutral', 'stable']
